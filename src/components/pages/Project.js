...
const Project = () => {
    const [projectsData] = useState([
        ...
        { imgsrc: newyear, title: "New-Year", description: "A New Year wishing page with animations" , github: "https://github.com/Gowtham-017/New_Year_2024", live: "",},
        ...
        { imgsrc: mycompany, title: "My-Company", description: "Employee Manager application connected with Database that effectively manages the details of the company's employee", github: "https://github.com/Gowtham-017/mycompany", live: "", },
        { imgsrc: fakeproduct, title: "FakeProduct-Detector", description: "A frontend design for a fake-product detection site using React" , github: "https://github.com/Gowtham-017/FakeProduct_Manager", live: "",},
        { imgsrc: mytodo, title: "To-Do-List", description: "My to-do app for managing tasks for the day using react and javascript", github: "https://github.com/Gowtham-017/To_Do_List", live: "https://to-do-stack.netlify.app/", },
        { imgsrc: drummachine, title: "DrumMachine", description: "A simple DrumMachine that you can use for making sounds and enjoy the music" , github: "https://github.com/Gowtham-017/DrumMachine", live: "",},
        ...
        { imgsrc: playlistmanager, title: "PlayList-Manager", description: "Integrated system for managing music playlist that is connected to database and I have used SpringBoot for the backend services" , github: "https://github.com/Gowtham-017/PlayList_Manager", live: "",},
        ...
        { imgsrc: internshipmanager, title: "Internship-Manager", description: "A console application developed using Java that manages internships registered by students" , github: "https://github.com/Gowtham-017/Internship_Manager", live: "",},
        { imgsrc: pythonandexcel, title: "Python-Excel", description: "Used Python to extract the data from folders to excel sheet and simplify it" , github: "https://github.com/Gowtham-017/Python_and_Excel", live: "",},
    ]);
    return (
        <div className='body'>
